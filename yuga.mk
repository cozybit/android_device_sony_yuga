...
# Config script for wcn36xx module
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/rootdir/system/etc/init.wcn36xx.sh:system/etc/init.wcn36xx.sh

PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/rootdir/system/etc/init.legacy_glibc.sh:system/etc/init.legacy_glibc.sh
